...
def create_app(test_config=None):
    ...
    def get_actors(jwt):
        ...
        it require the 'get:actor' permission
        '''
    ...
    def update_actor(jwt, actor_id):
        '''
        Patch a specific actor info.
        where <actor_id> is the existing actor id
        it require the 'patch:actor' permission
        '''
    ...
    def delete_actor(jwt, actor_id):
        ...
        where <actor_id> is the existing actor id
        it require the 'delete:actor' permission
        '''
        actor = Actors.query.filter(Actors.id == actor_id).one_or_none()
        if actor is None:
            abort(422)
    ...
    def get_movies(jwt):
        ...
        it require the 'get:movie' permission
        '''
    ...
    def update_movie(jwt, movie_id):
        '''
        Patch a specific movie info.
        where <movie_id> is the existing movie id
        it require the 'patch:movie' permission
        '''
        body = request.get_json()
        title = body.get('title')
        release = body.get('release')
    ...
    def delete_movie(jwt, movie_id):
        ...
        where <movie_id> is the existing movie id
        it require the 'delete:movie' permission
        '''
        movie = Movies.query.filter(Movies.id == movie_id).one_or_none()
        if movie is None:
            abort(422)
